...
#     driver = webdriver.Chrome(options=options, executable_path="/HW_lesson21/chromedriver")
#     yield driver
#     driver.quit()
#
#
...
def chrome_class(request):
    driver = webdriver.Chrome(executable_path="/Users/sabina/Desktop/Python/HW_lesson21/chromedriver")
    request.cls.driver = driver
    yield driver
    driver.quit()
