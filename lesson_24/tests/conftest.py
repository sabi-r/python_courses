...
def chrome():
    ...
    driver = webdriver.Chrome(options=options, executable_path="/Users/sabina/Desktop/Python/lesson_24/chromedriver")
    yield driver
    driver.quit()

@pytest.fixture(scope="class")
def firefox(request):
    driver = webdriver.Firefox(executable_path="/Users/sabina/Desktop/Python/lesson_24/geckodriver")
...
def chrome_class(request):
    driver = webdriver.Chrome(executable_path="/Users/sabina/Desktop/Python/lesson_24/chromedriver")
    request.cls.driver = driver
    yield driver
    driver.quit()
